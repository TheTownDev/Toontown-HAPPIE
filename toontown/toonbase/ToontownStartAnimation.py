...
"""
dnaStore = DNAStorage()
dnaFileName = "phase_8/dna/donalds_dreamland_9300.dna"
loadDNAFile(dnaStore, 'phase_4/dna/storage.dna')
loadDNAFile(dnaStore, 'phase_5/dna/storage_town.dna')
loadDNAFile(dnaStore, 'phase_8/dna/storage_DL.dna')
loadDNAFile(dnaStore, 'phase_8/dna/storage_DL_town.dna')
node = loadDNAFile(dnaStore, dnaFileName)
geom = render.attachNewNode(node)
"""
...
demotedCeo.dna.newSuit(SuitDNAGlobals.THE_CLUB_PRESIDENT_HARD)
...
demotedCeo.setDisplayName('The Club President\nBossbot\nTier 2')
demotedCeo.setH(180)
demotedCeo.battleTrap = -1


demotedCeo2 = DistributedSuitBase.DistributedSuitBase(base.cr)
demotedCeo2.doId = 2
demotedCeo2.dna = SuitDNA.SuitDNA()
demotedCeo2.dna.newSuit(SuitDNAGlobals.THE_OFFICE_CLERK_HARD)
...
demotedCeo2.setDisplayName('The Office Clerk\nLawbot\nTier 2')
demotedCeo2.setH(180)
demotedCeo2.battleTrap = -1


demotedCeo3 = DistributedSuitBase.DistributedSuitBase(base.cr)
demotedCeo3.doId = 3
demotedCeo3.dna = SuitDNA.SuitDNA()
demotedCeo3.dna.newSuit(SuitDNAGlobals.THE_MINT_AUDITOR_HARD)
...
demotedCeo3.setDisplayName('The Mint Auditor\nCashbot\nTier 2')
demotedCeo3.setH(180)
demotedCeo3.battleTrap = -1


demotedCeo4 = DistributedSuitBase.DistributedSuitBase(base.cr)
demotedCeo4.doId = 4
demotedCeo4.dna = SuitDNA.SuitDNA()
demotedCeo4.dna.newSuit(SuitDNAGlobals.THE_FACTORY_FOREMAN_HARD)
...
demotedCeo4.setDisplayName('The Factory Foreman\nSellbot\nTier 2')
demotedCeo4.battleTrap = -1

bbhq = loader.loadModel('phase_11/models/lawbotHQ/ttr_m_ara_lhq_officesZone55b')
