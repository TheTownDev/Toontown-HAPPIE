...
CarryLimits = (
    ...
    ((10, 0, 0, 0, 0, 0, 0), (10, 5, 0, 0, 0, 0, 0), (15, 10, 5, 0, 0, 0, 0), (20, 15, 10, 5, 0, 0, 0), (25, 20, 15, 7, 3, 0, 0), (30, 25, 20, 10, 4, 2, 0), (30, 25, 20, 15, 7, 3, 1)),
    ((10, 0, 0, 0, 0, 0, 0), (10, 5, 0, 0, 0, 0, 0), (15, 10, 5, 0, 0, 0, 0), (20, 15, 10, 5, 0, 0, 0), (25, 20, 15, 7, 3, 0, 0), (30, 25, 20, 10, 5, 2, 0), (30, 25, 20, 10, 5, 2, 1)),
    ((10, 0, 0, 0, 0, 0, 0), (10, 5, 0, 0, 0, 0, 0), (15, 10, 5, 0, 0, 0, 0), (20, 15, 10, 5, 0, 0, 0), (25, 20, 15, 7, 3, 0, 0), (30, 25, 20, 10, 5, 2, 0), (30, 25, 20, 15, 7, 3, 1)),
    ((10, 0, 0, 0, 0, 0, 0), (10, 5, 0, 0, 0, 0, 0), (15, 10, 5, 0, 0, 0, 0), (20, 15, 10, 5, 0, 0, 0), (25, 20, 15, 7, 3, 0, 0), (30, 25, 20, 10, 5, 2, 0), (30, 25, 20, 15, 7, 3, 1)),
    ((10, 0, 0, 0, 0, 0, 0), (10, 5, 0, 0, 0, 0, 0), (15, 10, 5, 0, 0, 0, 0), (20, 15, 10, 5, 0, 0, 0), (25, 20, 15, 7, 3, 0, 0), (30, 25, 20, 10, 5, 2, 0), (30, 25, 20, 15, 7, 3, 1)),
...
AvPropDamage = (
    (   # Toonup
        ...
        ((20, 30), (Levels[0][1], Levels[0][2])),
        ((35, 45), (Levels[0][2], Levels[0][3])),
        ((60, 80), (Levels[0][3], Levels[0][4])),
        ((60, 75), (Levels[0][4], Levels[0][5])),
        ((140, 160), (Levels[0][5], Levels[0][6])),
        ((200, 200), (Levels[0][6], regMaxSkill))
    ),
    (   # Trap
        ((16, 20), (Levels[1][0], Levels[1][1])),
        ((24, 30), (Levels[1][1], Levels[1][2])),
        ((40, 56), (Levels[1][2], Levels[1][3])),
        ((60, 90), (Levels[1][3], Levels[1][4])),
        ((110, 140), (Levels[1][4], Levels[1][5])),
        ((160, 185), (Levels[1][5], Levels[1][6])),
        ((200, 200), (Levels[1][6], MaxSkill))
    ),
    (   # Lure
        ((40, 40), (Levels[2][0], Levels[2][1])),
        ((20, 20), (Levels[2][1], Levels[2][2])),
        ((70, 70), (Levels[2][2], Levels[2][3])),
        ((50, 50), (Levels[2][3], Levels[2][4])),
        ((130, 130), (Levels[2][4], Levels[2][5])),
        ((90, 90), (Levels[2][5], Levels[2][6])),
        ((100, 130), (Levels[2][6], regMaxSkill))
    ),
    (   # Sound
