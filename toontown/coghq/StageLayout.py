...
LawOfficeLayout2_0 = [
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_DIAMOND_SINGLE_ROOM, JUNIOR_DIAMOND_GOON_ROOM, 1),
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_EVIDENCE_DOOM_ROOM, JUNIOR_TRAP_DIAMOND_ROOM, JUNIOR_BOOK_ROOM, 2)
]

LawOfficeLayout2_1 = [
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_DIAMOND_STOMPER_ROOM, JUNIOR_EVIDENCE_GOON_ROOM, JUNIOR_EVIDENCE_DOOM_ROOM, 1),
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_TRAP_LOBBY_ROOM, JUNIOR_DIAMOND_SINGLE_ROOM, JUNIOR_EVIDENCE_SINGLE_ROOM, 2)
]

LawOfficeLayout2_2 = [
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_TRAP_DIAMOND_ROOM, JUNIOR_DIAMOND_DOOM_ROOM, JUNIOR_EVIDENCE_GOON_ROOM, JUNIOR_DIAMOND_STOMPER_ROOM, 1),
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_DIAMOND_STOMPER_ROOM, JUNIOR_BOOK_ROOM, 2)
]

LawOfficeLayout2_3 = [
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_DIAMOND_GOON_ROOM, JUNIOR_EVIDENCE_GOON_ROOM, JUNIOR_BOOK_ROOM, JUNIOR_EVIDENCE_DOOM_ROOM, 1),
    (JUNIOR_ENTRANCE_ROOM, JUNIOR_BOX_DOOM_ROOM, JUNIOR_DIAMOND_STOMPER_ROOM, JUNIOR_LOBBY_COGS, 2)
]
