...
import random
CountryClubId2Layouts = {ToontownGlobals.BossbotCountryClubIntA: (0, 1, 2, 3, 4, 5),
 ToontownGlobals.BossbotCountryClubIntB: (6, 7, 8, 9, 10, 11),
 ToontownGlobals.BossbotCountryClubIntC: (12, 13, 14, 15, 16, 17)}
