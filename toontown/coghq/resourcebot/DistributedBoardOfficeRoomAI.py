...
from toontown.coghq.resourcebot import BoardOfficeRoomBase
from toontown.coghq.resourcebot import DistributedBoardOfficeBattleAI, BoardOfficeRoomSpecs
...
class DistributedBoardOfficeRoomAI(DistributedLevelAI.DistributedLevelAI, BoardOfficeRoomBase.BoardOfficeRoomBase):
    ...
    def getBattleCreditMultiplier(self):
        return ToontownBattleGlobals.getMintCreditMultiplier(self.boardofficeId)
    ...
    def generate(self):
        ...
        self.planner = LevelSuitPlannerAI.LevelSuitPlannerAI(self.air, self, DistributedFactorySuitAI.DistributedFactorySuitAI, DistributedBoardOfficeBattleAI.DistributedBoardOfficeBattleAI, cogSpecModule.CogData, cogSpecModule.ReserveCogData, cogSpecModule.BattleCells, battleExpAggreg=self.battleExpAggreg)
