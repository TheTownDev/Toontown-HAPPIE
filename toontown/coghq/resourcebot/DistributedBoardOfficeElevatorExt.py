...
class DistributedBoardOfficeElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setBoardOfficeId(self, boardofficeId):
        ...
        boardofficeId2originId = {ToontownGlobals.ResourcebotGeneralField: 0,
         ToontownGlobals.ResourcebotSpecialistField: 1,
         ToontownGlobals.ResourcebotSpecialistField2: 2}
    ...
    def getDestName(self):
        if self.boardofficeId == ToontownGlobals.ResourcebotGeneralField:
            return "Board Office 1"
        elif self.boardofficeId == ToontownGlobals.ResourcebotSpecialistField:
            return "Board Office 2"
        elif self.boardofficeId == ToontownGlobals.ResourcebotSpecialistField2:
