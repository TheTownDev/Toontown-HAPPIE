...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    SuitHoodInfo = [
                    ...
                    [2400, 12, 20, 0, 99, 100, 3, (1, 5, 10, 40, 60, 80), (40, 10, 10, 40), (1, 2, 3, 4), [], 4],

                    #Donalds Dock
                    [1100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 0, 50, 0), (3, 4, 5, 6), [], 4],
                    [1200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 25, 75), (3, 4, 5, 6), [], 4],
                    [1300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (25, 75, 0, 0), (3, 4, 5, 6), [], 4],

                    # Daisy Gardens
                    [5100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 50, 50, 0),  (4, 5, 6, 7), [], 4],
                    [5200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 25, 25, 0), (4, 5, 6, 7), [], 4],
                    [5300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100),  (4, 5, 6, 7, 8), [], 4],

                    # Minnies Melodyland
                    [4100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 0, 0, 50),  (4, 5, 6, 7, 8, 9), [], 7],
                    [4200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0),  (4, 5, 6, 7, 8, 9), [], 7],
                    [4300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (25, 0, 50, 25), (6, 7, 8, 9, 10), [], 8],

                    # The Brrrgh
                    [3100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (100, 0, 0, 0), (7, 8, 9, 10, 11), [], 7],
                    [3200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 50, 50), (7, 8, 9, 10, 11), [], 7],
                    [3300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0), (8, 9, 10, 11, 12), [], 7],

                    #Donalds Dreamland
                    [9100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (33, 34, 0, 33), (8, 9, 10, 11, 12), [], 7],
                    [9200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 100, 0),  (8, 9, 10, 11, 12), [], 7],
                    [9300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (60, 20, 0, 20),  (9, 10, 11, 12, 13), [], 7],
                    
                    #Clear Coasts
                    [7100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (33, 34, 0, 33), (8, 9, 10, 11, 12, 13), [], 7],
                    [7200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 100, 0),  (8, 9, 10, 11, 12, 13), [], 7],
                    [7300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (60, 20, 0, 20),  (9, 10, 11, 12, 13, 14), [], 7],
