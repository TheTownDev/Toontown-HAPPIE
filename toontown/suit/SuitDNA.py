...
__GENERAL_SUIT_ANIMATIONS: Set[SuitAnimation] = {
    ...
    SuitAnimation(key='powered-up', suit='A', path='powered-up', phase='5'),
    SuitAnimation(key='powered-up', suit='B', path='powered-up', phase='5'),
    SuitAnimation(key='powered-up', suit='C', path='powered-up', phase='5'),
    ...
    SuitAnimation(key='squirt-hose', suit='A', path='squirt-hose', phase='5'),
    SuitAnimation(key='squirt-hose', suit='B', path='squirt-hose', phase='5'),
    SuitAnimation(key='squirt-hose', suit='C', path='squirt-hose', phase='5'),
    SuitAnimation(key='pedal-the-foot', suit='A', path='pedal-the-foot', phase='5'),
    ...
    SuitAnimation(key='soundhit', suit='A', path='soundhit', phase='5'),
    SuitAnimation(key='soundhit', suit='B', path='soundhit', phase='5'),
    SuitAnimation(key='soundhit', suit='C', path='soundhit', phase='5'),
