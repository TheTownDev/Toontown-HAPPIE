...
class DistributedResourcebotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedResourcebotBoss')
    BallLaunchOffset = Point3(10.5, 8.5, -5)

    def __init__(self, cr):
        self.notify.debug('----- __init___')
        DistributedBossCog.DistributedBossCog.__init__(self, cr)
        FSM.FSM.__init__(self, 'DistributedResourcebotBoss')
        self.bossDamage = 0
    ...
    def enterPrepareBattleFour(self):
        ...
        seq.setPlayRate(self.cutsceneSpeed)
        self.storeInterval(seq, intervalName)
        self.playBossMusic('battle-pre-four')
