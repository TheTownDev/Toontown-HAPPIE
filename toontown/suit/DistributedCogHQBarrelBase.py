...
class DistributedCogHQBarrelBase(DistributedCogHQEntity, BarrelBase.BarrelBase, NodePath):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCogHQBarrelBase')

    def __init__(self, cr):
        self.rewardPerGrabMax = 0
        DistributedCogHQEntity.__init__(self, cr)
        node = hidden.attachNewNode('DistributedCogHQBarrelBase')
