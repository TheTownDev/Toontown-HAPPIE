...
class SuitPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.guiTop = DirectFrame(
            ...
            image_scale=(0.045, 1, 0.055),
            image_pos=(0, 10, -0.690),
        )
        ...
        self.silverLabel = DirectLabel(parent=self, relief=None, pos=(-0.25, 0, -1.4), scale=priceScale, image=silverModel, image_pos=(-0.4, 0, 0.4), text=str(localAvatar.emblems[ToontownGlobals.EmblemTypes.Silver]), text_fg=(0.95, 0.95, 0, 1), text_shadow=(0, 0, 0, 1), text_font=ToontownGlobals.getSignFont(), text_align=TextNode.ALeft)
        self.goldLabel = DirectLabel(parent=self, relief=None, pos=(0.25, 0, -1.4), scale=priceScale, image=goldModel, image_pos=(-0.4, 0, 0.4), text=str(localAvatar.emblems[ToontownGlobals.EmblemTypes.Gold]), text_fg=(0.95, 0.95, 0, 1), text_shadow=(0, 0, 0, 1), text_font=ToontownGlobals.getSignFont(), text_align=TextNode.ALeft)
